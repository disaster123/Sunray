...
if [ ! -e "/tmp/kernel_drv_wlan" ]; then
  ...
  ( sleep 3; bash -c 'rmmod 8821cu && ( sleep 5; insmod /home/pi/Sunray/8821cu.ko rtw_drv_log_level=1 rtw_led_ctrl=0 rtw_power_mgnt=0; systemctl restart networking; systemctl restart wpa_supplicant;  )' >/home/pi/Sunray/kernel_driver.log 2>&1 ) &
