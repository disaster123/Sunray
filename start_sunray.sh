...
( sleep 30; bash -c 'rmmod 8821cu && ( sleep 5; insmod /home/pi/Sunray/8821cu.ko rtw_power_mgnt=0 rtw_ips_mode=0; systemctl restart networking; systemctl restart wpa_supplicant;  )' >/home/pi/Sunray/kernel_driver.log 2>&1 ) &
