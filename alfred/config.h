...
#define BUMPER_DEADTIME 300  		// linear motion dead-time (ms) after bumper is allowed to trigger
...
#define GPS_MOTION_DETECTION_TIMEOUT  20      // timeout for motion (secs)
